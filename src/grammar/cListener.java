...
public interface cListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link cParser#ternaryExpression}.
	 * @param ctx the parse tree
	 */
	void enterTernaryExpression(cParser.TernaryExpressionContext ctx);
	/**
	 * Exit a parse tree produced by {@link cParser#ternaryExpression}.
	 * @param ctx the parse tree
	 */
	void exitTernaryExpression(cParser.TernaryExpressionContext ctx);
	/**
